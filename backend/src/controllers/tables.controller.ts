...
export const tablesController = {
  ...
  async getAllZoneItems(req: Request, res: Response) {
    try {
  ...
  async createTableBooking(req: Request, res: Response) {
    try {
      const {
        tableId,
        date,
  ...
  async getTableBookings(req: Request, res: Response) {
    try {
  ...
  async updateBookingStatus(req: Request, res: Response) {
    try {
      ...
      const booking = await prisma.reservation.update({
        where: { id: Number(id) },
        data: { status: status as 'booked' | 'arrived' | 'no_show' | 'cancelled' }
      })
  ...
  async getTablesStats(req: Request, res: Response) {
    try {
