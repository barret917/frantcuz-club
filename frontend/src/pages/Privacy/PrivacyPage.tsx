        ...
        <SectionContainer>
          ...
          <ContentSection>
            ...
            <SectionContent>
              <Text>
                <p>
                  <strong>Оператор:</strong> ООО «ЭкоСтар», адрес: г. Москва, ул. Салтыковская, 49А, ТЦ Волна, -1 этаж. Оператор осуществляет деятельность в сфере общественного питания и развлечений.
                </p>
              </Text>
            </SectionContent>
          </ContentSection>
          ...
          <ContactInfo>
            ...
            <ContactDetails>
              <span>📧</span>
              <span>
                Для реализации своих прав субъект персональных данных может обратиться к Оператору лично либо направить письменный запрос по электронной почте: <strong>Скоро будет другая почта</strong>
              </span>
            </ContactDetails>
          </ContactInfo>
        </SectionContainer>
