...
const ServiceIcon = styled.div<{ $isHovered: boolean }>`
  ...
  ${props => props.$isHovered && css`
    ...
    &::after {
      opacity: 1;
      animation: ${css`rotate`} 3s linear infinite;
    }
  `}
      ...
      <SectionContainer>
        ...
        <ServicesContent>
          ...
          >
            ...
            <ServiceTitle>🛍️ Француз шоп</ServiceTitle>
            <ServiceDescription>
          ...
          >
            ...
            <ServiceDescription>
              Профессиональные тренеры научат вас всем секретам игры
            </ServiceDescription>
          </ServiceCard>
          ...
          >
            ...
            <ServiceDescription>
              Развивайте свой голос под руководством опытных педагогов
            </ServiceDescription>
          </ServiceCard>
