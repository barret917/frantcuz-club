        ...
        <ServicesContent>
          ...
          >
            <ServiceIcon $isHovered={hoveredCard === 0}>
              <img 
                src="/images/free-icon-banquet-7381833.png" 
                alt="Банкеты" 
                style={{ 
                  width: '65%', 
                  height: '65%', 
          ...
          >
            <ServiceIcon $isHovered={hoveredCard === 2}>
              <img 
                src="/images/free-icon-hookah-5207983.png" 
                alt="Кальян" 
                style={{ 
                  width: '65%', 
                  height: '65%', 
          ...
          >
            ...
            <ServiceTitle>🛍️ Магазин Француз</ServiceTitle>
            <ServiceDescription>
          ...
          >
            ...
            <ServiceTitle>🎯 Академия Француз</ServiceTitle>
            <ServiceDescription>
          ...
          >
            ...
            <ServiceDescription>
              Быстрая доставка к вашему офису и дому
            </ServiceDescription>
          </ServiceCard>
          ...
          >
            ...
            <ServiceDescription>
              Трудоустройство для желающих найти работу и профессиональный подбор персонала для вашего бизнеса
            </ServiceDescription>
          </ServiceCard>
        </ServicesContent>
      </SectionContainer>
